  ...
  return (
    <React.Fragment>
      <section
        ...
        />
        <div
          className="quote-outer-container bg-[--darkblue] -rotate-3 flex justify-center items-center scale-110 pt-32 pb-32 max-lg:pt-16 max-lg:pb-16 max-lg:-ml-44 max-lg:-mr-44 max-lg:scale-100  max-[767px]:border-4 border-red-500  max-[1024px]:rotate-0"
          style={{
          ...
          <div className="title-container flex flex-col gap-6 mb-24 rotate-3 justify-between items-center max-lg:w-[100vw] max-[767px]:border-4 border-red-500 max-[1024px]:rotate-0">
            <motion.div
